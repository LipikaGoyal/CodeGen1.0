...
export default {
  ...
  SIGNIN_HEADING: 'Continue With CodeGen',
  SIGNIN_SUBHEADING: 'To use CodeGen you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using CodeGen, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use CodeGen a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
